...
export function Pruebas() {
  ...
  let toggleClassCheck = btnState ? " w-full h-full" : "1/2";
  let titleCard = btnState ? "x-auto my-4" : "-auto";
  let bodyCard = btnState ? "opacity-100 -translate-y-3" : "opacity-0 translate-y-3";
  ...
  return (
    <section className="flex h-[700px] bg-slate-600 max-w-screen-sm mx-auto">
      <div className="flex flex-wrap relative my-auto w-full aspect-square">
        <div className={`w-${toggleClassCheck} bg-yellow-500 transition-all h-1/2 flex flex-col absolute top-0 text-center left-0 z-10`}>
            ...
            <p className={`${bodyCard}  transition-all duration-300 ease-in-out w-72 mx-auto`}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Maxime ipsa sed facilis!</p>
        </div>
